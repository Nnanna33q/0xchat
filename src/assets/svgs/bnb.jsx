import bnbImg from "../imgs/bnb-logo-network.png";
...
export function BnbLogoNetwork() {
    return (
        <img className="size-3 absolute top-0 right-0 ring ring-primary rounded-full" src={bnbImg} />
    )
}